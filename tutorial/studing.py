...
engine = create_engine("mysql+pymysql://root:westos@localhost:3306/fastapi", encoding='utf-8')
# 把当前的引擎绑定给这个会话；
...
#     import uvicorn
#     uvicorn.run(app=app, host="192.168.56.20", port=8000, debug=True)